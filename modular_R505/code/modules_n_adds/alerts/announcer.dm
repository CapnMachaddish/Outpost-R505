/datum/centcom_announcer/default
	welcome_sounds = list('modular_R505/sound/voice/announcer/welcome_placeholder.ogg')
	alert_sounds = list('modular_R505/sound/alert/notify2.ogg')
	command_report_sounds = list('modular_R505/sound/alert/notify2.ogg')
	event_sounds = list(ANNOUNCER_AIMALF = 'sound/ai/default/aimalf.ogg',
		...
		ANNOUNCER_CAPTAIN = 'modular_R505/sound/alert/notify2.ogg',
