...
/datum/looping_sound/rbmk_reactor
	mid_length = 16
	mid_sounds = list('modular_R505/sound/rbmkport/reactor_hum.ogg' = 10)
	volume = 10
...
/obj/machinery/atmospherics/components/trinary/nuclear_reactor
	...
	icon = 'modular_R505/icons/obj/machines/rbmk.dmi'
...
/obj/machinery/atmospherics/components/trinary/nuclear_reactor/proc/on_entered(datum/source, atom/movable/arrived, atom/oldloc, list/atom/old_locs)
...
/obj/machinery/atmospherics/components/trinary/nuclear_reactor/proc/slowprocess()
	...
	if(moderator_input.total_moles() >= minimum_coolant_level)
		...
		if(total_degradation_moles >= minimum_coolant_level*0.5) //I'll be nice.
			...
			playsound(src, pick('modular_R505/sound/rbmkport/sm_accent_normal_1.ogg','modular_R505/sound/rbmkport/sm_accent_normal_2.ogg','modular_R505/sound/rbmkport/sm_accent_normal_3.ogg','modular_R505/sound/rbmkport/sm_accent_normal_4.ogg','modular_R505/sound/rbmkport/sm_accent_normal_5.ogg'), 100, TRUE)
...
/obj/machinery/atmospherics/components/trinary/nuclear_reactor/proc/handle_alerts()
	...
	if(warning)
		...
		relay('modular_R505/sound/rbmkport/alarm.ogg', null, loop=TRUE, channel = CHANNEL_REACTOR_ALERT)
		set_light(0)
...
/obj/machinery/atmospherics/components/trinary/nuclear_reactor/proc/meltdown()
	...
	relay('modular_R505/sound/rbmkport/meltdown.ogg', "<span class='userdanger'>You hear a horrible metallic hissing.</span>")
	stop_relay(CHANNEL_REACTOR_ALERT)
...
/obj/machinery/atmospherics/components/trinary/nuclear_reactor/proc/start_up()
	...
	desired_k = 1
	set_light(10)
	var/startup_sound = pick('modular_R505/sound/rbmkport/startup.ogg', 'modular_R505/sound/rbmkport/startup2.ogg')
...
/obj/item/twohanded/required/fuel_rod
	...
	icon = 'modular_R505/icons/obj/control_rod.dmi'
...
/obj/machinery/computer/reactor
	...
	light_power = 1
	light_range = 3
	icon = 'modular_R505/icons/obj/machines/rbmk_computer.dmi'
	icon_state = "oldcomp"
	icon_screen = "library"
	icon_keyboard = null
...
/obj/machinery/computer/reactor/fuel_rods/attack_hand(mob/living/user)
	...
	if(!fuel_rod)
		return
	playsound(src, pick('modular_R505/sound/rbmkport/switch.ogg','modular_R505/sound/rbmkport/switch2.ogg','modular_R505/sound/rbmkport/switch3.ogg'), 100, FALSE)
	playsound(reactor, 'modular_R505/sound/rbmkport/crane_1.wav', 100, FALSE)
...
/obj/machinery/computer/reactor/pump/attack_hand(mob/living/user)
	...
	if(!is_operational)
		return FALSE
	playsound(loc, pick('modular_R505/sound/rbmkport/switch.ogg','modular_R505/sound/rbmkport/switch2.ogg','modular_R505/sound/rbmkport/switch3.ogg'), 100, FALSE)
...
/obj/effect/decal/nuclear_waste
	...
	icon = 'modular_R505/icons/obj/machines/reactor_parts.dmi'
...
/obj/effect/decal/nuclear_waste/proc/on_entered(datum/source, atom/movable/arrived, atom/oldloc, list/atom/old_locs)
	if(isliving(arrived))
		var/mob/living/L = arrived
...
/datum/weather/nuclear_fallout
	...
	weather_sound = 'modular_R505/sound/rbmkport/falloutwind.ogg'
	end_duration = 100
	area_type = /area
...
/obj/item/sealant
	name = "Reactor sealant"
	desc = "A spray can suitable for fixing reactor seals."
	icon = 'modular_R505/icons/obj/sealant.dmi'
	icon_state = "sealant"
	w_class = 1
