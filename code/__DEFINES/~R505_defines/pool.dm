...
GLOBAL_LIST_INIT(blacklisted_pool_reagents, list(
	...
	/datum/reagent/drug/pentacamphor, /datum/reagent/breast_enlarger, /datum/reagent/penis_enlarger, /datum/reagent/consumable/cum, //Lewd shit BEGONE! pt. 2
	/datum/reagent/consumable/girlcum, /datum/reagent/consumable/milk/breast_milk //Lewd shit BEGONE! pt. 3
	))
