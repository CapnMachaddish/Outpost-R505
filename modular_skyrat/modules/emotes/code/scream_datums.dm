...
/datum/scream_type/robotic
	name = "Robotic Scream"
	male_screamsounds = list('modular_R505/sound/voice/scream_dialup1.ogg', 'modular_R505/sound/voice/scream_dialup2.ogg') //R505 Edit - Original: male_screamsounds = list('modular_skyrat/modules/emotes/sound/voice/scream_silicon.ogg')
	female_screamsounds = null
