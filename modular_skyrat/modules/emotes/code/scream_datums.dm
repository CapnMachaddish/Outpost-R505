...
/datum/scream_type/robotic
	name = "Robotic Scream"
	male_screamsounds = list('modular_R505/sound/voice/scream_dialup1.ogg', 'modular_skyrat/modules/emotes/sound/emotes/scream_silicon.ogg', 'modular_R505/sound/voice/scream_dialup2.ogg')
	female_screamsounds = null
